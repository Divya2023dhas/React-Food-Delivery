const Staters = [
  {
    ...
    price: "₹190",
    image:process.env.PUBLIC_URL + "/images/grilledsan.jpg",
  },
  {
    id: 2,
    name: "veg-Sandwitch",
    price: "₹100",
    image:process.env.PUBLIC_URL + "/images/grilledsandwitch.jpg",
  },
   {
    id:3,
    name: "panner sandwitch",
    price: "₹180",
    image:process.env.PUBLIC_URL + "/images/sandwich.jpg",
  },
  {
    id:4,
